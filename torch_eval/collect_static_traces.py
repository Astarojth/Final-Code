...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max-items-per-dataset", type=int, default=None, help="Optional per-dataset item cap.")
    parser.add_argument("--max-actions", type=int, default=None, help="Optional cap on grid actions.")
